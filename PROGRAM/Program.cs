...
namespace AppRestrictor
{
    static class Program
    {
        ...
        private static bool IsSystemProcess(Process proc)
        {
            try
            {
                return proc.StartInfo.UserName == "SYSTEM" ||
                       ...
                       proc.ProcessName.Equals("svchost", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("winlogon", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("taskhostw", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("wuauserv", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("cryptsvc", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("spoolsv", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("mspmsnsv", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("audiosrv", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("eventlog", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("msdtc", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("nla", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("dpi", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("fontdrvhost", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("plugplay", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("sppsvc", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("lsm", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("conhost", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("msedge", StringComparison.OrdinalIgnoreCase) ||
                       proc.ProcessName.Equals("NVDisplay.Container.exe", StringComparison.OrdinalIgnoreCase);
            }
            catch
            {
                return false; // 프로세스 정보에 접근할 수 없는 경우 false 반환
            }
        }
